        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">      
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-cogs"></i> <span>ZONAS</span>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="<?php echo base_url();?>clientes"><i class="fa fa-circle-o"></i> Zonas </a></li>
                            
                        </ul>
                    </li>
                    <li class="treeview">
                        <a href="#">
                            <i class="fa fa-share-alt"></i> <span>USUARIOS</span>
                            <span class="pull-right-container">
                                <i class="fa fa-angle-left pull-right"></i>
                            </span>
                        </a>
