...
<section class="content">
    ...
    <div class="card">
                    ...
                    <div class="body">
                    <a class="btn  btn-raised btn-success waves-effect" href="<?=base_url("domiciliario/aggdomiciliario")?>">Agregar</a>                        <div class="table-responsive">
                           <table class="table table-striped">
                             ...
                             <tr>
                                ...
                                <td>
                                    <a class="btn  btn-raised btn-success waves-effect" href="<?=base_url("domiciliario/mod/$fila->idDomiciliario")?>">Modificar</a>
                                    <a class="btn  btn-raised btn-danger waves-effect" href="<?=base_url("domiciliario/eliminar/$fila->idDomiciliario")?>">Eliminar</a>
                                </td>
