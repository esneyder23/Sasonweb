    ...
    <aside id="leftsidebar" class="sidebar"> 
        ...
        <div class="menu">
            <ul class="list">
                ...
                <ul class="ml-menu">
                        <li><a href="doctors.html">Plato</a></li>
                        <li><a href="add-doctor.html">Adición</a></li>
                    </ul>
                </li>
...
<section class="content home">
    ...
    <tbody>
    <tr>
        <form action="<?=base_url("/zonas/add");?>" method="post">
            <td></td>
            <td>
...
?>
    <tr>
        ...
        <td>
            <a href="<?=base_url("zonas/mod/$fila->idZona")?>">Modificar</a>
            <a href="<?=base_url("zonas/eliminar/$fila->idZona")?>">Eliminar</a>
        </td>
    </tr>
<?php
