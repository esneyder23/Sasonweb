...
<form action="" method="POST">
            ...
            <input type="text"  name="nombre" onkeypress="return soloLetras(event)" title="solo se permite ingresar letras" required value="<?=$fila->nombre?>"/>            
            <input type="submit" name="submit" value="Modificar"/>
            <?php } ?>
        </form>
<a href="<?=base_url("domiciliario")?>">Volver</a>
</div>
</div>
</div>
